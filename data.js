...
/*
{
    "code": "FRIENDLYFIRE ",
        "rewards": [
            {
                "img": "imgs/reedcode_reward/energy_friendly_matches.webp",
                "num": 3
            },
            {
            ...
            {
                "img": "imgs/coins/elite_troop.webp",
                "num": 3
            },
            {
                "img": "imgs/reedcode_reward/refill_iron_250k.webp",
                "num": 1
            },
            {
...
const sourceReverseMap = {
    ...
    "月活动 - 恋爱季节": "love", "哥布林召唤": "goblin", "额外抽奖 - 秘密召唤": "secretsummon", "神话召唤 - 额外抽奖": "tavernoflegendssecret",
    ...
    "月活動 - 戀愛季節": "love", "哥布林召喚": "goblin", "額外抽獎 - 秘密召喚": "secretsummon", "傳奇召喚 - 額外抽獎": "tavernoflegendssecret", "星界召喚": "astral", "野地召喚": "wilderness",
    ...
    "Monthly Event - Love Season": "love", "Goblin Summon": "goblin", "Extra Draw - Secret Summon": "secretsummon", "Legends Summon - Extra Draw": "tavernoflegendssecret",
...
const sourceIconMap = {
    ...
    "love": "s1.webp", "goblin": "goblin.webp", "secretsummon": "lucky.webp",
    ...
    "harvest": "diamond.webp", "monsterisland": "monster_angular.webp", "opera": "challenge.webp", "challengefestival1": "challenge.webp", "challengefestival2": "challenge.webp", "costume": "costume_key.webp", "mimic": "bazaar.webp", "temple": "temple.webp", "titanhunter": "diamond.webp", "farmland": "challenge.webp", "lunarnewyear2026": "fortune_spirit_resource.webp", "beachparty2026": "beachparty_resource.webp",
};
...
const skillTagReverseMap = {
    ...
    "防禦-反擊/反彈：烈火": "防御-反击/反弹：烈火",
    "防禦-反擊/反彈：冰雪": "防御-反击/反弹：冰雪",
    ...
    "Dmg - Dmg ↑ : Ice": "伤害-伤害↑：冰雪",
    "Dmg - Dmg ↑ : Fire": "伤害-伤害↑：烈火",
    ...
    "Atk - Normal Attack ↑": "攻击-普通攻击力↑",
    "Atk - Increment Normal Attack ↑": "攻击-递增普通攻击力↑",
    "Atk - Attack ↑": "攻击-攻击力↑",
    "Atk - Increment Attack ↑": "攻击-递增攻击力↑",
    ...
    "Def - Increment Counterattack": "防御-递增反击",
    "Def - Reflect : Dark": "防御-反击/反弹：暗黑",
    "Def - Reflect : Fire": "防御-反击/反弹：烈火",
    "Def - Reflect : Ice": "防御-反击/反弹：冰雪",
    "Def - Reflect : Holy": "防御-反击/反弹：神圣",
    "Def - Reflect : Nature": "防御-反击/反弹：自然",
    "Def - Growth : Def↑": "防御-成长：防御力↑",
    "Def - Hide/Ambush": "防御-潜行/伏击",
    ...
    "Debuff": "负面效果",
    "Atk - Attack ↓": "攻击-攻击力↓",
    "Atk - Decrement Attack ↓": "攻击-递减攻击力↓",
    "Atk - Accuracy ↓": "攻击-命中率↓",
    "Atk - Decrement Accuracy ↓": "攻击-递减命中率↓",
    "Atk - Provoked": "攻击-恼怒",
    "Atk - Stack : Atk ↓": "攻击-叠加：攻击力↓",
    ...
    "Def - Def ↓ : Special": "防御-防御↓：特殊技能",
    "Def - Defense ↓": "防御-防御力↓",
    "Def - Decrement Defense ↓": "防御-递减防御力↓",
    "Def - Stack : Def ↓": "防御-叠加：防御力↓",
...
const PassiveSkillIconCollection = {
    ...
    "greater_healing": "passive_greater_healing_legendary_troop",
    "outgoing_heal_modifier_legendary_troop": "NULL_SPRITE",
    "max_health_reduction_immunity_legendary_troop": "NULL_SPRITE",
    "enable_critical_special_hit_legendary_troop": "NULL_SPRITE",
    "critical_advantage_modifier_legendary_troop": "NULL_SPRITE",
    "critical_advantage": "passive_critical_advantage_legendary_troop",
    "bleed_on_counter_attack": "status_bleed_on_counterattack",
    "mimic_food_red": "passive_mimic_training_hero_red",
    "mimic_food_green": "passive_mimic_training_hero_green",
    "mimic_food_blue": "passive_mimic_training_hero_blue",
    "mimic_food_yellow": "passive_mimic_training_hero_yellow",
    "mimic_food_purple": "passive_mimic_training_hero_purple",
    "resist_ailments_red": "passive_resist_ailment_red",
    "resist_ailments_blue": "passive_resist_ailment_blue",
    "resist_ailments_green": "passive_resist_ailment_green",
    "resist_ailments_purple": "passive_resist_ailment_purple",
    "resist_ailments_yellow": "passive_resist_ailment_yellow",
    "dishonorable_death_rare": "passive_dishonorable_death",
    "dishonorable_death_epic": "passive_dishonorable_death",
    "lucky_legendary_troop": "passive_lucky_legendary_troop",
    "resist_frost_with_health_boost_and_mana_costume": "passive_health_boost_and_mana_on_frost_resist_myrkheim",
    "arctic_core_costume": "passive_arctic_core",
    "vengeful_ghost_on_damage_received": "passive_vengeful_ghost",
    "camouflage_on_special_cast": "passive_petal_veil",
    "buff_sacrifice": "NULL_SPRITE",
    "resist_water_with_health_boost_and_mana": "passive_resist_water_with_health_boost_and_mana",
    "mesmerize_over_time_dryad": "passive_petal_rain",
    "vengeful_ghost_on_damage_received_rare_and_epic": "passive_vengeful_ghost",
    "reduce_growth_on_special": "passive_reduce_growth",
    "dealt_damage_modifier_per_water_ailment_on_target": "passive_increase_damage_per_water_ailment_on_target",
    "stop_chain_strikes": "passive_stop_chain",
    "resist_all_stealing": "status_ransac",
    "resist_resonance": "status_radiation",
    "contain_spreading_ailments": "passive_contain_spreading_ailment",
    "reduce_enemies_stacks_on_special": "passive_reduce_stacks",
    "mimic_iron_red": "passive_mimic_training_hero_red",
    "mimic_iron_green": "passive_mimic_training_hero_green",
    "mimic_iron_blue": "passive_mimic_training_hero_blue",
    "mimic_iron_yellow": "passive_mimic_training_hero_yellow",
    "mimic_iron_purple": "passive_mimic_training_hero_purple",
    "bypass_counterattack_and_reflection": "passive_bypass_counterattack",
    "cheat_death_epic_and_rare": "passive_cheat_death",
    "ransack_epic_and_rare": "passive_thiefs_opportunity",
