...
// ▼▼▼▼▼ 定义四个技能分类的排序规则 ▼▼▼▼▼
const skillTagOrder_base = ["复活", "治疗：即时", "治疗：提高生命", "治疗：持续", "治疗：特殊", "治疗：伤害量", "攻击：单体", "攻击：两侧", "攻击：邻近轻伤", "攻击：范围", "攻击：全体", "攻击：随机", "攻击：数量变化", "攻击：持续伤害"];
const skillTagOrder_special = ["净化状态异常", "驱散增益", "额外伤害", "额外攻击", "穿透/绕过", "无视闪避", "穿透小兵", "摧毁小兵", "小兵", "摧毁小兵获得法力", "移除小兵造成伤害", "偷取小兵", "超级小兵", "摧毁恶魔", "连锁", "爆炸", "吞噬粘物", "法力恢复", "法力恢复（击杀）", "法力偷取", "削减法力", "偷取增益", "增益重新分配", "负面效果重新分配", "重置增益回合", "重置负面效果回合", "叠加：持续伤害", "叠加：生命恢复", "叠加：法力生成", "面板：伤害", "面板：生命恢复", "面板：提高伤害", "面板：防御力", "面板：法力生成", "面板：暴击", "通过伤害治疗", "通过小兵治疗", "回溯/偷取技能", "赌博/随机效果", "自我恢复"];
const skillTagOrder_buff = ["攻击力↑", "防御力↑", "暴击率↑", "法力生成↑", "伤害↑", "特殊技能伤害↑", "治疗量↑", "防御↑：火焰", "防御↑：冰霜", "防御↑：自然", "防御↑：神圣", "防御↑：暗黑", "防御↑：特殊技能", "伤害↑：火焰", "伤害↑：冰霜", "伤害↑：自然", "伤害↑：神圣", "伤害↑：暗黑", "叠加：攻击力↑", "叠加：防御力↑", "成长：攻击力", "成长：防御力", "反击/反弹", "反弹负面效果", "闪避", "嘲讽", "伤害减免", "伤害分担", "免疫状态异常", "阻止负面效果", "阻止增益驱散", "阻止最大生命值↓", "阻止恶魔", "阻止复活", "潜行/幽灵形态", "拟态", "替换为增益", "恢复", "自我复活", "复活：施法者", "增益被驱散时造成伤害", "自我减益"];
const skillTagOrder_debuff = ["攻击力↓", "防御力↓", "命中率↓", "治疗量↓", "受到伤害↑", "法力生成↓/阻止", "最大生命值↓", "防御↓：火焰", "防御↓：冰霜", "防御↓：自然", "防御↓：神圣", "防御↓：暗黑", "防御↓：特殊技能", "攻击力↓：暗黑", "叠加：攻击力↓", "叠加：防御力↓", "叠加：受到伤害↑", "叠加：法力生成↓", "衰退：攻击力", "衰退：防御力", "持续伤害：燃烧", "持续伤害：水", "持续伤害：毒", "持续伤害：流血", "持续伤害：沙", "持续伤害：冰冻", "持续伤害：诅咒", "增益无效化", "天赋技能无效化", "阻止净化", "阻止治疗", "阻止小兵", "混乱/沉默/睡眠", "狂乱", "麻痹", "生命偷取", "法力偷取", "偷取治疗", "替换为负面效果", "减少增益回合", "初始化负面效果回合", "负面效果被净化时造成伤害", "改变颜色/位置"];
