...
const skillTagOrder_special = ["状态-幽灵形态", "状态-跳舞", "状态-偷取增益", "状态-减少状态异常回合", "状态-减少增益回合", "状态-替换为增益", "状态-替换为负面效果", "状态-增益重新分配", "状态-负面效果重新分配", "状态-重置/增加增益回合", "状态-重置/增加负面效果回合", "法力-削减法力", "法力-法力偷取", "法力-摧毁小兵获得法力", "法力-法力恢复", "法力-法力恢复（击杀）", "法力-面板：法力生成", , "攻击-偷取小兵", "攻击-回溯/偷取技能", "攻击-摧毁小兵", "攻击-无视闪避", "攻击-抓挠", "攻击-穿透/绕过", "攻击-穿透小兵", "攻击-赌博/随机效果", "攻击-面板：攻击力", "攻击-面板：暴击", "伤害-面板：提高伤害", "伤害-伤害↑：烈火", "伤害-伤害↑：自然", "伤害-伤害↑：冰雪", "伤害-伤害↑：神圣", "伤害-伤害↑：暗黑", "伤害-条件触发", "伤害-移除小兵造成伤害", "伤害-额外伤害", "治疗-自我恢复/提高生命", "治疗-通过伤害治疗", "治疗-通过小兵治疗", "召唤-小兵", "召唤-恶魔", "召唤-摧毁恶魔", "召唤-超级小兵", "召唤-超级恶魔"];
