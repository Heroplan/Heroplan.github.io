...
const skillTagOrder_special = ["状态-幽灵形态", "状态-跳舞", "状态-偷取增益", "状态-减少状态异常回合", "状态-减少增益回合", "状态-替换为增益", "状态-替换为负面效果", "状态-增益重新分配", "状态-负面效果重新分配", "状态-重置/增加增益回合", "状态-重置/增加负面效果回合", "法力-削减法力", "法力-法力偷取", "法力-摧毁小兵获得法力", "法力-法力恢复", "法力-法力恢复（击杀）", "法力-面板：法力生成", , "攻击-偷取小兵", "攻击-回溯/偷取技能", "攻击-摧毁小兵", "攻击-无视闪避", "攻击-穿透/绕过", "攻击-穿透小兵", "攻击-赌博/随机效果", "攻击-面板：攻击力", "攻击-面板：暴击", "伤害-伤害↑：冰雪", "伤害-伤害↑：暗黑", "伤害-伤害↑：烈火", "伤害-伤害↑：神圣", "伤害-伤害↑：自然", "伤害-条件触发", "伤害-移除小兵造成伤害", "伤害-面板：提高伤害", "伤害-额外伤害", "治疗-自我恢复/提高生命", "治疗-通过伤害治疗", "治疗-通过小兵治疗", "召唤-小兵", "召唤-恶魔", "召唤-摧毁恶魔", "召唤-超级小兵", "召唤-超级恶魔"];
const skillTagOrder_buff = ["状态-驱散增益", "状态-粘糊表面", "状态-阻止增益驱散", "状态-免疫状态异常", "状态-阻止负面效果", "状态-反弹负面效果", "状态-阻止恶魔", "法力-法力生成↑", "法力-法力恢复", "法力-叠加：法力生成↑", "伤害-条件触发", "攻击-技能攻击力↑", "攻击-攻击力↑", "攻击-成长：攻击力↑", "攻击-叠加：攻击力↑", "攻击-叠加：暴击率↑", "攻击-暴击率↑", "攻击-穿透/绕过", "防御-拟态", "防御-闪避", "防御-叠加：伤害减免", "防御-潜行/伏击", "防御-伤害减免", "防御-伤害分担", "防御-防御力↑", "防御-成长：防御力↑", "防御-叠加：防御力↑", "防御-防御↑：特殊技能", "防御-反击/反弹", "防御-反击/反弹：冰雪", "防御-反击/反弹：暗黑", "防御-反击/反弹：烈火", "防御-反击/反弹：神圣", "防御-反击/反弹：自然", "防御-防御↑：冰雪", "防御-防御↑：暗黑", "防御-防御↑：烈火", "防御-防御↑：神圣", "防御-防御↑：自然", "防御-嘲讽", "治疗-自我复活", "治疗-自我恢复", "治疗-治疗量↑", "治疗-叠加：生命恢复", "治疗-阻止最大生命值↓"];
const skillTagOrder_debuff = ["状态-净化状态异常", "状态-阻止净化", "状态-增益无效化", "状态-反弹增益", "状态-吞噬粘物", "状态-天赋技能无效化", "状态-狂乱", "状态-自我减益", "状态-重置/增加负面效果回合", "状态-阻止小兵", "状态-小兵腐化", "法力-法力偷取", "法力-法力生成↓/阻止", "法力-叠加：法力生成↓","法力-睡眠", "法力-混乱/沉默", "法力-麻痹", "伤害-条件触发", "攻击-攻击力↓", "攻击-衰退：攻击力↓", "攻击-叠加：攻击力↓", "攻击-命中率↓", "伤害-叠加：持续伤害", "伤害-持续伤害：冰冻", "伤害-持续伤害：毒", "伤害-持续伤害：水", "伤害-持续伤害：奔涌流水", "伤害-持续伤害：沙", "伤害-持续伤害：流血", "伤害-持续伤害：奔涌流血", "伤害-持续伤害：燃烧", "伤害-持续伤害：生命偷取", "伤害-持续伤害：诅咒", "伤害-持续伤害：共振", "防御-受到伤害↑", "防御-叠加：受到伤害↑", "防御-防御力↓", "防御-衰退：防御力↓", "防御-叠加：防御力↓", "防御-防御↓：特殊技能", "防御-防御↓：冰雪", "防御-防御↓：暗黑", "防御-防御↓：烈火", "防御-防御↓：神圣", "防御-防御↓：自然", "防御-改变颜色/位置", "治疗-偷取治疗", "治疗-最大生命值↓", "治疗-治疗量↓", "治疗-阻止复活", "治疗-阻止治疗"];
