...
// ▼▼▼▼▼ 定义四个技能分类的排序规则 ▼▼▼▼▼
const skillTagOrder_base = ["治疗：复活", "治疗：即时", "治疗：提高生命", "治疗：持续", "治疗：特殊", "治疗：伤害量", "攻击：单体", "攻击：随机", "攻击：数量变化", "攻击：两侧", "攻击：邻近轻伤", "攻击：范围", "攻击：全体", "伤害：持续伤害"];
const skillTagOrder_special = ["法力-削减法力", "法力-摧毁小兵获得法力", "法力-法力恢复（击杀）", "法力-面板：法力生成", , "攻击-偷取小兵", "攻击-回溯/偷取技能", "攻击-摧毁小兵", "攻击-无视闪避", "攻击-穿透/绕过", "攻击-穿透小兵", "攻击-赌博/随机效果", "攻击-连锁", "攻击-面板：攻击力", "攻击-面板：暴击", "攻击-额外攻击", "伤害-伤害↑：冰霜", "伤害-伤害↑：暗黑", "伤害-伤害↑：火焰", "伤害-伤害↑：神圣", "伤害-伤害↑：自然", "伤害-爆炸", "伤害-移除小兵造成伤害", "伤害-面板：提高伤害", "伤害-额外伤害", "治疗-自我恢复", "治疗-通过伤害治疗", "治疗-通过小兵治疗", "召唤-小兵", "召唤-恶魔", "召唤-摧毁恶魔", "召唤-超级小兵", "召唤-超级恶魔", "状态-偷取增益", "状态-减少状态异常回合", "状态-替换为增益", "状态-替换为负面效果", "状态-增益重新分配", "状态-负面效果重新分配", "状态-重置增益回合", "状态-重置负面效果回合"];
...
const skillTagOrder_debuff = ["状态-净化状态异常", "状态-阻止净化", "状态-增益无效化", "状态-反弹增益", "法力-法力偷取", "法力-法力生成↓/阻止", "法力-叠加：法力生成↓", "法力-混乱/沉默/睡眠", "攻击-叠加：攻击力↓", "攻击-命中率↓", "攻击-攻击力↓", "攻击-衰退：攻击力↓", "伤害-叠加：持续伤害", "伤害-持续伤害：冰冻", "伤害-持续伤害：毒", "伤害-持续伤害：水", "伤害-持续伤害：沙", "伤害-持续伤害：流血", "伤害-持续伤害：燃烧", "伤害-持续伤害：生命偷取", "伤害-持续伤害：诅咒", "治疗-偷取治疗", "防御-受到伤害↑", "防御-叠加：受到伤害↑", "防御-防御力↓", "防御-衰退：防御力↓", "防御-叠加：防御力↓", "防御-防御↓：特殊技能", "防御-防御↓：冰霜", "防御-防御↓：暗黑", "防御-防御↓：火焰", "防御-防御↓：神圣", "防御-防御↓：自然", "防御-改变颜色/位置","治疗-最大生命值↓","治疗-治疗量↓","治疗-阻止复活","治疗-阻止治疗","法力-麻痹","状态-减少增益回合","状态-吞噬粘物","状态-天赋技能无效化","状态-狂乱","状态-自我减益","状态-重置负面效果回合","状态-阻止小兵"];
