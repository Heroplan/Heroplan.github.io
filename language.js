...
const i18n = {
    cn: {
        ...
        resultsCountTextUnfiltered: (count) => `游戏内共有 ${count} 位英雄 (包含服装)`,
        resultsCountTextHeroOnly: (count) => `游戏内共有 ${count} 位英雄 (不含服装)`,
        resultsCountTextCostumeOnly: (count) => `游戏内共有 ${count} 件服装`,
        favoritesListCount: (count) => `收藏列表中有 ${count} 位英雄`,
    ...
    tc: {
        ...
        resultsCountTextUnfiltered: (count) => `遊戲內共有 ${count} 位英雄 (包含服裝)`,
        resultsCountTextHeroOnly: (count) => `遊戲內共有 ${count} 位英雄 (不含服裝)`,
        resultsCountTextCostumeOnly: (count) => `遊戲內共有 ${count} 件服裝`,
        favoritesListCount: (count) => `收藏清單中有 ${count} 位英雄`,
