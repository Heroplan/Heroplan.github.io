...
const i18n = {
    cn: {
        ...
        skillTypeHelpContent: `<p>您可以选择不同的技能分类标签来源进行筛选：</p><ul><li><strong>Heroplan.io:</strong> 数据来自 <a href="https://heroplan.io/" target="_blank" rel="noopener noreferrer">Heroplan.io</a> 网站。</li><li><strong>By Nynaeve:</strong> 数据来自 <a href="http://www.theravenscave.com/" target="_blank" rel="noopener noreferrer">www.theravenscave.com</a>，经过AI补全和人工审核。</li><li><strong>bbcamp.info:</strong> 标签定义参考<a href="https://bbcamp.info" target="_blank" rel="noopener noreferrer">bbcamp.info</a>，经过AI修正和人工审核。</li><li><strong>全部:</strong> 同时搜索以上所有来源的标签。</li></ul><p>各类别的详细定义，请参考源网站。</p>`,
    ...
    tc: {
        ...
        skillTypeHelpContent: `<p>您可以選擇不同的技能分類標籤來源進行篩選：</p><ul><li><strong>Heroplan.io:</strong> 資料來自 <a href="https://heroplan.io/" target="_blank" rel="noopener noreferrer">Heroplan.io</a> 網站。</li><li><strong>By Nynaeve:</strong> 資料來自 <a href="http://www.theravenscave.com/" target="_blank" rel="noopener noreferrer">www.theravenscave.com</a>，經過AI補全和人工審核。</li><li><strong>bbcamp.info:</strong> 標籤定義參考<a href="https://bbcamp.info" target="_blank" rel="noopener noreferrer">bbcamp.info</a>，經過AI修正和人工審核。</li><li><strong>全部:</strong> 同時搜索以上所有來源的標籤。</li></ul><p>各類別的詳細定義，请參考源網站。</p>`,
    ...
    en: {
        ...
        skillTypeHelpContent: `<p>You can select different sources for skill category tags to filter by:</p><ul><li><strong>Heroplan.io:</strong> Data from the <a href="https://heroplan.io/" target="_blank" rel="noopener noreferrer">Heroplan.io</a> website.</li><li><strong>By Nynaeve:</strong> Data from <a href="http://www.theravenscave.com/" target="_blank" rel="noopener noreferrer">www.theravenscave.com</a>, supplemented by AI and manually reviewed.</li><li><strong>bbcamp.info:</strong> Tag definitions reference <a href="https://bbcamp.info" target="_blank" rel="noopener noreferrer">bbcamp.info</a>, revised by AI and manually reviewed.</li><li><strong>All:</strong> Searches tags from all of the above sources simultaneously.</li></ul><p>For detailed category definitions, please refer to the source websites.</p>`,
